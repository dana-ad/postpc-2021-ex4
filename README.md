...
ANSWER:
we can add a time-out feature to the calculation service and also change the 'give-up' time value to this value at the intent.
In tests environments we can create a service with the 200ms time and when creating a service not for testing - to pass a value of 20 seconds.
